...
class GetchuStrategy extends SiteStrategy {
    ...
    async selfTest() {
        ...
        const expectedGameData = {
            ...
            makerJp: '美蕾（みらい）',
            imageUrlJp:
                'http://image.getchu.com/brandnew/671747/c671747package.jpg',
            additionalImages: [
                'http://image.getchu.com/brandnew/671747/c671747sample1.jpg',
                'http://image.getchu.com/brandnew/671747/c671747sample2.jpg',
            ],
        };
...
function getImages(query) {
    return query('a.highslide')
        ...
        .map((i, e) => {
            const href = query(e).attr('href');
            if (href.startsWith('./')) {
                return href.replace('./', 'http://image.getchu.com/');
